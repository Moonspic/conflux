   ...
   <q-page class="q-pa-lg bg-dark text-accent container">
      <div class="row justify-between items-center q-gutter-lg">
         ...
         <section class="row items-center">
            ...
            />
            <q-btn color="accent" flat :label="$t('showarchived')" no-caps :to="{ name: 'books' }" />
         </section>
      </div>

      <div class="q-pa-lg row justify-start items-start q-gutter-xl">
...
export default {
   ...
   computed: {
      books() {
         return this['store/all']({ collection: 'books' })
      },
   },
